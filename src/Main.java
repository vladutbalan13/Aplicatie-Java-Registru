    ...
    public static void main(String[] args) {
        ...
        buton2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                l.setText(String.valueOf(reg.ListaAngajati) + '\n');
                System.out.println(reg.ListaAngajati);
                l.setEditable(false);
                l.setFont(new Font("TimesRoman", Font.PLAIN, 20));
                Aplicatie.removeAll();
                Aplicatie.setLayout(new GridLayout(2,1));
                //l.setBounds(100, 100, 700, 70);
                Aplicatie.add(l);
                Aplicatie.add(menu);
                Aplicatie.revalidate();
                Aplicatie.repaint();
                menu.setBounds(300,400,200,100);
                menu.addMouseListener(new MouseAdapter() {
                    @Override
                    public void mouseClicked(MouseEvent e) {
                        Aplicatie.removeAll();
        ...
        buton5.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Angajat employee_mod = new Angajat();
                Aplicatie.removeAll();
                Label name = new Label("Introduceti numele angajatului pe care doriti sa il modificati");
                Label age = new Label("Introduceti varsta angajatului pe care doriti sa il modificati");
                Label job_ = new Label("Introduceti job-ul angajatului pe care doriti sa il modificati");
                TextField nume = new TextField("Scrieti numele..");
                nume.setBounds(50, 100, 200, 30);
                TextField varsta = new TextField("Scrieti varsta..");
                TextField job = new TextField("Scrieti jobul..");
                ...
                nume.addKeyListener(new KeyAdapter() {
                    ...
                    public void keyPressed(KeyEvent e) {
                        super.keyPressed(e);
                        if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                            employee_mod.nume = nume.getText();
                            varsta.requestFocusInWindow();
                        }
                    }
                });
                ...
                varsta.addKeyListener(new KeyAdapter() {
                    ...
                    public void keyPressed(KeyEvent e) {
                        super.keyPressed(e);
                        if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                            employee_mod.varsta = Integer.parseInt(varsta.getText());
                ...
                job.addKeyListener(new KeyAdapter() {
                    ...
                    public void keyPressed(KeyEvent e) {
                        super.keyPressed(e);
                        if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                            employee_mod.locdemunca = job.getText();
                            for(int i = 0; i <= reg.ListaAngajati.size(); i++) {
                                if (employee_mod == reg.ListaAngajati.get(i)) {
                                    try {
                                        Angajat employee_mod2 = new Angajat();
                                        Aplicatie.removeAll();
                                        Label name = new Label("Introduceti numele angajatului care va fi inlocuit");
                                        Label age = new Label("Introduceti varsta angajatului care va fi inlocuit");
                                        Label job_ = new Label("Introduceti job-ul angajatului care va fi inlocuit");
                                        TextField nume = new TextField("Scrieti numele..");
                                        nume.setBounds(50, 100, 200, 30);
                                        TextField varsta = new TextField("Scrieti varsta..");
                                        TextField job = new TextField("Scrieti jobul..");
                                        ...
                                        nume.addKeyListener(new KeyAdapter() {
                                            ...
                                            public void keyPressed(KeyEvent e) {
                                                super.keyPressed(e);
                                                if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                                                    employee_mod2.nume = nume.getText();
                                                    varsta.requestFocusInWindow();
                                                }
                                            }
                                        });
                                        ...
                                        varsta.addKeyListener(new KeyAdapter() {
                                            ...
                                            public void keyPressed(KeyEvent e) {
                                                super.keyPressed(e);
                                                if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                                                    employee_mod2.varsta = Integer.parseInt(varsta.getText());
                                        ...
                                        job.addKeyListener(new KeyAdapter() {
                                            ...
                                            public void keyPressed(KeyEvent e) {
                                                super.keyPressed(e);
                                                if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                                                    employee_mod2.locdemunca = job.getText();
                                                    Label finish = new Label("Persoana adaugata!", CENTER);
                                                    finish.setForeground(Color.green);
                                                    finish.setFont(new Font("TimesRoman", Font.PLAIN, 30));
                                                    finish.setAlignment(Label.CENTER);
                                                    ...
                                                    menu.addMouseListener(new MouseAdapter() {
                                                        ...
                                                        public void mouseClicked(MouseEvent e) {
                                                            ...
                                                            Aplicatie.revalidate();
                                                            Aplicatie.repaint();
                                                            reg.modify_angajat(employee_mod, employee_mod2);
                                                        }
                                                    });
                                                }
                                            }
